  ...
  return (
    <div>
      ...
      <section className="px-6 pt-12 pb-0">
        <div className="type-label mb-4" style={{ color: "#bbb" }}>Tram Gallery — Open Call</div>
        <div
          className="font-black uppercase leading-none"
          style={{ fontSize: "clamp(64px, 14vw, 200px)", letterSpacing: "-0.05em", lineHeight: 0.85 }}
        >
          OPEN<br />
          <span style={{ color: "#E3000B" }}>CALL</span>
        </div>
      </section>
      ...
      <section>
        {[
          ...
          <div key={item.num} className="flex border-b-4 border-black">
            <div
              className="font-black leading-none px-6 py-8 shrink-0 border-r-4 border-black"
              style={{ fontSize: "clamp(32px, 4vw, 52px)", letterSpacing: "-0.04em", color: "#E3000B", width: "clamp(80px, 12vw, 140px)" }}
            >
              {item.num}
            </div>
